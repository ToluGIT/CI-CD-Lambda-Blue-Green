...
2.  **Security Scans**
    ...
    *   **Dependency Scanning with Safety:** Checks Python dependencies for known vulnerabilities.
...
---
 ...
 ### **2\. Dependency Scanning with Safety**
    
   *   **Tool Used:** Safety
   *   **Purpose:** Checks Python dependencies listed in `requirements.txt` for known security vulnerabilities.
   *   **Integration:** Added as a pipeline stage called **"Security: Dependency Scan"**.
    
### **3\. Infrastructure as Code Scanning with cfn-nag**
...
*   [Safety Documentation](https://safetycli.com/?utm_source=data&utm_medium=redirect&utm_campaign=data_rd&utm_id=0624&utm_content=marketing)
